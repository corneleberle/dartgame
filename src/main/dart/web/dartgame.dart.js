...
["dart.math", "dart:math", , P, {
  ...
  Point: {
    ...
    $add: function(_, other) {
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t1 = new P.Point(this.x + t2, J.$add$ns(this.y, t1.get$y(other)));
      t1.$builtinTypeInfo = this.$builtinTypeInfo;
      return t1;
    },
    $isPoint: true
...
["", "dartgame.dart", , N, {
  ...
  main_closure5: {
    "": "Closure:15;",
    call$1: function(e) {
      var t1, message, payload;
      t1 = $.get$myCannon();
      message = new F.ShotRequestMessage(t1.angle, t1.power, "SHOT_REQUEST", P.DateTime$_now());
      payload = C.C_JsonCodec.encode$1(message.getBaseMap$0());
      $.webSocket.send(payload);
      N.outputMsg("SHOT_REQUEST" + ":\n" + C.C_JsonCodec.encode$1(message.getBaseMap$0()));
      return;
    }
  },
  connect_closure: {
    ...
    call$1: function(e) {
      ...
      t1 = $.get$myNameText();
      connectMessage = new F.ConnectMessage(J.get$value$x(t1), "CONNECT", P.DateTime$_now());
...
["", "messages.dart", , F, {
  ...
  ConnectMessage: {
    "": "AbstractMessage;name,messageType,sent",
    getBaseMap$0: function() {
  ...
  ShotRequestMessage: {
    "": "AbstractMessage;angle,power,messageType,sent",
    getBaseMap$0: function() {
      var mapData = F.AbstractMessage.prototype.getBaseMap$0.call(this);
