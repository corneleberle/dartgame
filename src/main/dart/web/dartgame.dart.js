...
ButtonElement: {"": "HtmlElement;disabled},value=", "%": "HTMLButtonElement"},
...
ObjectElement: {"": "HtmlElement;data=,height},width%", "%": "HTMLObjectElement"},
...
SelectElement: {"": "HtmlElement;disabled},length=,value=", "%": "HTMLSelectElement"},

SpeechRecognitionError: {"": "Event;error=", "%": "SpeechRecognitionError"},

StyleElement: {"": "HtmlElement;disabled}", "%": "HTMLStyleElement"},

TextAreaElement: {"": "HtmlElement;disabled},value=", "%": "HTMLTextAreaElement"},
...
FEBlendElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEBlendElement"},

FEColorMatrixElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEColorMatrixElement"},

FEComponentTransferElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEComponentTransferElement"},

FECompositeElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFECompositeElement"},

FEConvolveMatrixElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEConvolveMatrixElement"},

FEDiffuseLightingElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEDiffuseLightingElement"},

FEDisplacementMapElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEDisplacementMapElement"},

FEFloodElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEFloodElement"},

FEGaussianBlurElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEGaussianBlurElement"},

FEImageElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEImageElement"},

FEMergeElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEMergeElement"},

FEMorphologyElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEMorphologyElement"},

FEOffsetElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFEOffsetElement"},

FEPointLightElement: {"": "SvgElement;x=,y=", "%": "SVGFEPointLightElement"},

FESpecularLightingElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFESpecularLightingElement"},

FESpotLightElement: {"": "SvgElement;x=,y=", "%": "SVGFESpotLightElement"},

FETileElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFETileElement"},

FETurbulenceElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFETurbulenceElement"},

FilterElement: {"": "SvgElement;width=,x=,y=", "%": "SVGFilterElement"},

ForeignObjectElement: {"": "GraphicsElement;width=,x=,y=", "%": "SVGForeignObjectElement"},
...
ImageElement0: {"": "GraphicsElement;width=,x=,y=", "%": "SVGImageElement"},

MaskElement: {"": "SvgElement;width=,x=,y=", "%": "SVGMaskElement"},

PatternElement: {"": "SvgElement;width=,x=,y=", "%": "SVGPatternElement"},

RectElement: {"": "GraphicsElement;width=,x=,y=", "%": "SVGRectElement"},
...
SvgSvgElement: {"": "GraphicsElement;width=,x=,y=", "%": "SVGSVGElement"},
...
UseElement: {"": "GraphicsElement;width=,x=,y=", "%": "SVGUseElement"}}],
...
Point: {"": "Object;x>,y>",
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !t1.$isPoint)
      return false;
    return this.x === other.x && J.$eq(this.y, other.y);
  },
  get$hashCode: function(_) {
    var t1, t2;
    t1 = this.x & 0x1FFFFFFF;
  ...
  $mul: function(_, factor) {
    var t1 = J.$mul$n(this.y, factor);
    t1 = new P.Point(this.x * factor, t1);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(this, "Point", 0)]);
    return t1;
  },
  $isPoint: true
...
main: function() {
  ...
  t1 = $.get$angleSlider();
  t1.toString;
  t2 = C.EventStreamProvider_change._eventType;
  ...
  t4 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new N.main_closure0()), t3._useCapture);
  ...
  t3 = new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new N.main_closure1()), t4._useCapture);
  ...
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure2()), t2._useCapture);
  ...
  t3 = new W._ElementEventStreamImpl(t3, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new N.main_closure3()), t3._useCapture);
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure4()), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = $.get$triggerButton();
  t3.toString;
  t3 = new W._ElementEventStreamImpl(t3, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new N.main_closure5()), t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = $.get$connectButton();
  t2.toString;
...
updateCannon: function(cannon) {
  var t1, angleDegree;
  t1 = J.get$valueAsNumber$x($.get$angleSlider());
  if (typeof t1 !== "number")
    throw t1.$div();
  cannon.angle = 1.5707963267948966 - t1 / 180 * 3.141592653589793;
  t1 = J.get$valueAsNumber$x($.get$powerSlider());
  if (typeof t1 !== "number")
    throw t1.$div();
  cannon.power = t1 / 1000;
  t1 = cannon.angle;
  if (typeof t1 !== "number")
    throw t1.$div();
  angleDegree = t1 / 3.141592653589793 * 180;
  t1 = $.rightCannon;
  if (cannon == null ? t1 == null : cannon === t1)
    angleDegree = 180 - angleDegree;
  $.get$angleValue().textContent = C.JSNumber_methods.toStringAsFixed$1(angleDegree, 0) + "\u00b0";
  $.get$powerValue().textContent = J.get$value$x($.get$powerSlider());
  N.drawCannon(cannon);
},

drawCannon: function(cannon) {
  var t1, tempCanvas, t2, t3, t4, t5, t6, t7;
  t1 = $.leftCannon;
  tempCanvas = (cannon == null ? t1 == null : cannon === t1) ? $.get$cannonLeftCanvas() : $.get$cannonRightCanvas();
  J.get$context2D$x(tempCanvas).clearRect(0, 0, tempCanvas.width, tempCanvas.height);
  t1 = tempCanvas.getContext("2d");
  t1.beginPath();
  t1.lineWidth = 5;
  t1.strokeStyle = "red";
  t2 = cannon.pos;
  ...
  if (typeof t5 !== "number")
    throw t5.$sub();
  t1.arc(0 + t3 * t2.x, t5 - t6 * t4, 5, 0, 3.141592653589793, true);
  t1.closePath();
  t1.stroke();
  t1.fillStyle = "red";
  t1.font = "18px Arial";
  t1.textAlign = "center";
  t4 = J.toString$0(cannon.remainingShots);
  t6 = cannon.pos;
  t5 = $.get$SCALE_X();
  if (typeof t5 !== "number")
    throw t5.$mul();
  ...
  if (typeof t3 !== "number")
    throw t3.$sub();
  C.CanvasRenderingContext2D_methods.fillText$3(t1, t4, 0 + t5 * t6.x, t3 - t7 * t2 + 20);
  t2 = tempCanvas.getContext("2d");
  t2.save();
  t2.lineWidth = 5;
  t2.fillStyle = "red";
  t2.strokeStyle = "red";
  ...
  if (typeof t5 !== "number")
    throw t5.$sub();
  t2.translate(0 + t3 * t7.x, t5 - t4 * t6);
  t6 = cannon.angle;
  if (typeof t6 !== "number")
    throw t6.$negate();
  t2.rotate(-t6);
...
drawShotCurve: function(cannon, canvas) {
  var flying, i, time, t1, t2, t3, x, t4, t5, y, position;
  J.get$context2D$x(canvas).clearRect(0, 0, canvas.width, canvas.height);
  flying = true;
  i = 0;
  do {
    time = i * 0.001;
    ...
    x = t1.x + (1 * t2 * time * Math.cos(t3) + 0.1 * $.wind * time);
    t1 = cannon.pos;
    t2 = cannon.power;
    if (typeof t2 !== "number")
      throw H.iae(t2);
    ...
    if (typeof t5 !== "number")
      throw H.iae(t5);
    y = J.$add$ns(t1.y, (1 * t2 * time * t3 - 0.2 * time * time) * t4 / t5);
    if (x <= 0 || x >= 1 || J.$lt$n(y, 0))
      flying = false;
    else {
      t1 = J.get$length$asx($.get$landscape());
      if (typeof t1 !== "number")
        throw H.iae(t1);
      position = C.JSNumber_methods.toInt$0(x * t1);
      if (J.$lt$n(y, J.elementAt$1$ax($.get$landscape(), position))) {
        t1 = $.get$SCALE_X();
        if (typeof t1 !== "number")
          throw t1.$mul();
        t2 = $.get$OFFSET_Y();
    ...
    if (C.JSInt_methods.$mod(i, 25) === 0) {
      ...
      if (typeof t2 !== "number")
        throw t2.$sub();
      N.drawCircle(canvas, 0 + t1 * x, t2 - t3 * y, "orange", 1);
    }
    ++i;
  } while (flying);
  N.redrawCanvas();
...
drawEnd: function(text) {
  var t1, t2, t3;
  t1 = J.get$context2D$x($.get$endCanvas());
  t1.beginPath();
  t2 = $.get$CANVAS_WIDTH();
  if (typeof t2 !== "number")
    throw t2.$div();
  t3 = $.get$CANVAS_HEIGHT();
  if (typeof t3 !== "number")
    throw t3.$div();
  t1.rect(t2 / 2 - 150, t3 / 2 - 50, 300, 100);
  ...
  t1.stroke();
  t1.fillStyle = "black";
  t1.font = "bold 72px Arial";
  t1.textAlign = "center";
  t3 = $.get$CANVAS_WIDTH();
  if (typeof t3 !== "number")
    throw t3.$div();
  t2 = $.get$CANVAS_HEIGHT();
  if (typeof t2 !== "number")
    throw t2.$div();
  t1.fillText(text, t3 / 2, t2 / 2 + 25);
},
...
drawLandscape: function(mapProfile) {
  var t1, t2, t3, t4, t5, i, t6, t7;
  t1 = J.get$context2D$x($.get$landscapeCanvas());
  t1.beginPath();
  t1.lineWidth = 2;
  t1.fillStyle = "lightgrey";
  t1.strokeStyle = "black";
  t2 = J.getInterceptor$ax(mapProfile);
  t3 = t2.elementAt$1(mapProfile, 0);
  t4 = $.get$OFFSET_Y();
  t5 = $.get$SCALE_Y();
  if (typeof t5 !== "number")
    throw t5.$mul();
  ...
  if (typeof t4 !== "number")
    throw t4.$sub();
  t1.moveTo(0, t4 - t5 * t3);
  i = 1;
  while (true) {
    t1 = t2.get$length(mapProfile);
    if (typeof t1 !== "number")
      throw H.iae(t1);
    if (!(i < t1))
      break;
    t1 = J.get$context2D$x($.get$landscapeCanvas());
    t3 = t2.get$length(mapProfile);
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t4 = $.get$SCALE_X();
    if (typeof t4 !== "number")
      throw t4.$mul();
    t5 = t2.elementAt$1(mapProfile, i);
    t6 = $.get$OFFSET_Y();
    t7 = $.get$SCALE_Y();
    if (typeof t7 !== "number")
      throw t7.$mul();
    ...
    if (typeof t6 !== "number")
      throw t6.$sub();
    t1.lineTo(0 + t4 * (1 / t3 * i), t6 - t7 * t5);
    ++i;
  }
  t1 = J.get$context2D$x($.get$landscapeCanvas());
  t3 = $.get$SCALE_X();
  ...
  if (typeof t5 !== "number")
    throw t5.$sub();
  t1.lineTo(0 + t4 * 0, t5 - t2 * 0);
  t1.fill();
  t1.closePath();
  t1.stroke();
},

drawWindsock: function(force) {
  var tempCanvas, t1, t2, t3;
  tempCanvas = W.CanvasElement_CanvasElement(200, 200);
  t1 = J.get$context2D$x(tempCanvas);
  t1.translate(100, 100);
  t1.rotate(-force * 3.141592653589793 / 2);
  t2 = $.get$windsockImage();
  t3 = J.get$width$x($.get$windsockImage());
  if (typeof t3 !== "number")
    throw t3.$negate();
  t1.drawImage(t2, -t3 / 2, 0);
  J.get$context2D$x($.get$windsockCanvas()).drawImage(tempCanvas, 0, -90);
},

redrawCanvas: function() {
  var t1 = $.get$masterCanvas();
  t1.toString;
  t1 = t1.getContext("2d");
  t1.clearRect(0, 0, $.get$masterCanvas().width, $.get$masterCanvas().height);
  t1.drawImage($.get$landscapeCanvas(), 0, 0);
  t1.drawImage($.get$cannonLeftCanvas(), 0, 0);
  t1.drawImage($.get$cannonRightCanvas(), 0, 0);
  t1.drawImage($.get$windsockCanvas(), 0, 0);
  t1.drawImage($.get$leftFlightpathCanvas(), 0, 0);
  t1.drawImage($.get$rightFlightpathCanvas(), 0, 0);
  t1.drawImage($.get$endCanvas(), 0, 0);
},
...
getCannonPos: function(landscape, posX) {
  ...
  t2 = t1.get$length(landscape);
  if (typeof posX !== "number")
    throw posX.$div();
  if (typeof t2 !== "number")
    throw H.iae(t2);
  t1 = new P.Point(posX / t2, t1.$index(landscape, posX));
  H.setRuntimeTypeInfo(t1, [null]);
  return t1;
},
...
main_closure0: {"": "Closure;",
  call$1: function(e) {
    ...
    if (typeof t3 !== "number")
      throw t3.$add();
    t2.set$valueAsNumber(t1, t3 + -1);
    t2.set$maxLength(t1, 1000);
...
main_closure5: {"": "Closure;",
  call$1: function(e) {
    return N.sendShotRequest($.get$myCannon());
  },
  $is_args1: true
},
...
connect_closure1: {"": "Closure;",
  call$1: function(e) {
    ...
    message = C.C_JsonCodec.decode$1(t1.get$data(e));
    if (message != null && J.get$isNotEmpty$asx(message)) {
      t2 = J.getInterceptor$asx(message);
      if (J.$eq(t2.$index(message, "messageType"), "INIT")) {
        $.landscape = t2.$index(message, "landscape");
        t3 = t2.$index(message, "wind");
        if (typeof t3 !== "number")
          throw t3.$div();
        $.wind = t3 / 1000;
        cannonLeftPos = N.getCannonPos($.get$landscape(), t2.$index(message, "canonLeftX"));
        cannonRightPos = N.getCannonPos($.get$landscape(), t2.$index(message, "canonRightX"));
        if (J.$eq(t2.$index(message, "playerType"), "LEFT")) {
          enemyName = J.$index$asx(t2.$index(message, "playerNames"), "RIGHT");
          $.get$myCannon().pos = cannonLeftPos;
          $.get$myCannon().remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "LEFT");
          $.get$enemyCannon().pos = cannonRightPos;
          $.get$enemyCannon().remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "RIGHT");
          $.leftCannon = $.get$myCannon();
          $.rightCannon = $.get$enemyCannon();
        } else {
          enemyName = J.$index$asx(t2.$index(message, "playerNames"), "LEFT");
          $.get$myCannon().pos = cannonRightPos;
          $.get$myCannon().remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "RIGHT");
          $.get$enemyCannon().pos = cannonLeftPos;
          $.get$enemyCannon().remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "LEFT");
      ...
      if (J.$eq(t2.$index(message, "messageType"), "SHOT")) {
        ...
        power = t2.$index(message, "power");
        if (J.$eq(t2.$index(message, "shooter"), "LEFT")) {
          t3 = $.leftCannon;
          t3.angle = angle;
          t3.power = power;
          t3.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "LEFT");
          N.drawCannon($.leftCannon);
          N.drawShotCurve($.leftCannon, $.get$leftFlightpathCanvas());
        } else {
          t3 = $.rightCannon;
          t3.angle = angle;
          t3.power = power;
          t3.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "RIGHT");
          N.drawCannon($.rightCannon);
...
Cannon: {"": "Object;pos,angle,power,remainingShots,player"}},
1],
...
AbstractMessage: {"": "Object;",
  toJson$0: function() {
    return C.C_JsonCodec.encode$1(this.getBaseMap$0());
  },
...
ShotRequestMessage: {"": "AbstractMessage;angle,power,messageType,sent",
  getBaseMap$0: function() {
    ...
    mapData.$indexSet(mapData, "power", this.power);
    return mapData;
  }
}}],
]);
...
Isolate.$lazy($, "angleValue", "angleValue", "get$angleValue", function() {
  return document.querySelector("#angleValue");
});
Isolate.$lazy($, "powerValue", "powerValue", "get$powerValue", function() {
  return document.querySelector("#powerValue");
});
Isolate.$lazy($, "angleSlider", "angleSlider", "get$angleSlider", function() {
  return document.querySelector("#angleSlider");
});
Isolate.$lazy($, "angleMinus", "angleMinus", "get$angleMinus", function() {
  return document.querySelector("#angleMinus");
});
Isolate.$lazy($, "anglePlus", "anglePlus", "get$anglePlus", function() {
  return document.querySelector("#anglePlus");
});
Isolate.$lazy($, "powerSlider", "powerSlider", "get$powerSlider", function() {
  return document.querySelector("#powerSlider");
});
Isolate.$lazy($, "powerMinus", "powerMinus", "get$powerMinus", function() {
  return document.querySelector("#powerMinus");
});
Isolate.$lazy($, "powerPlus", "powerPlus", "get$powerPlus", function() {
  return document.querySelector("#powerPlus");
});
Isolate.$lazy($, "triggerButton", "triggerButton", "get$triggerButton", function() {
  return document.querySelector("#trigger");
});
Isolate.$lazy($, "myNameText", "myNameText", "get$myNameText", function() {
  return document.querySelector("#myName");
});
Isolate.$lazy($, "connectButton", "connectButton", "get$connectButton", function() {
  return document.querySelector("#connect");
});
Isolate.$lazy($, "windsockImage", "windsockImage", "get$windsockImage", function() {
  return document.querySelector("#windsock");
});
Isolate.$lazy($, "masterCanvas", "masterCanvas", "get$masterCanvas", function() {
  return H.interceptedTypeCast(document.querySelector("#canvas"), "$isCanvasElement");
});
Isolate.$lazy($, "CANVAS_WIDTH", "CANVAS_WIDTH", "get$CANVAS_WIDTH", function() {
  return $.get$masterCanvas().width;
});
Isolate.$lazy($, "CANVAS_HEIGHT", "CANVAS_HEIGHT", "get$CANVAS_HEIGHT", function() {
  return $.get$masterCanvas().height;
});
Isolate.$lazy($, "SCALE_X", "SCALE_X", "get$SCALE_X", function() {
  return $.get$CANVAS_WIDTH();
});
Isolate.$lazy($, "SCALE_Y", "SCALE_Y", "get$SCALE_Y", function() {
  return $.get$CANVAS_HEIGHT();
});
Isolate.$lazy($, "OFFSET_Y", "OFFSET_Y", "get$OFFSET_Y", function() {
  return $.get$CANVAS_HEIGHT();
});
Isolate.$lazy($, "cannonLeftCanvas", "cannonLeftCanvas", "get$cannonLeftCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "cannonRightCanvas", "cannonRightCanvas", "get$cannonRightCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "leftFlightpathCanvas", "leftFlightpathCanvas", "get$leftFlightpathCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "rightFlightpathCanvas", "rightFlightpathCanvas", "get$rightFlightpathCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "landscapeCanvas", "landscapeCanvas", "get$landscapeCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "windsockCanvas", "windsockCanvas", "get$windsockCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "endCanvas", "endCanvas", "get$endCanvas", function() {
  var t1 = $.get$CANVAS_WIDTH();
  return W.CanvasElement_CanvasElement($.get$CANVAS_HEIGHT(), t1);
});
Isolate.$lazy($, "landscape", "landscape", "get$landscape", function() {
  return P.List_List(1000, null);
});
Isolate.$lazy($, "myCannon", "myCannon", "get$myCannon", function() {
  var t1 = new P.Point(0, 0);
  H.setRuntimeTypeInfo(t1, [null]);
  return new N.Cannon(t1, 0, 0, 0, null);
});
Isolate.$lazy($, "enemyCannon", "enemyCannon", "get$enemyCannon", function() {
  var t1 = new P.Point(0, 0);
  H.setRuntimeTypeInfo(t1, [null]);
  return new N.Cannon(t1, 0, 0, 0, null);
});
...
//# sourceMappingURL=dartgame.dart.js.map
//@ sourceMappingURL=dartgame.dart.js.map
