...
["dart.dom.html", "dart:html", , W, {
  ...
  InputElement: {
    "": "HtmlElement;disabled},height},maxLength},value=,valueAsNumber%,width%",
    "%": "HTMLInputElement"
  },
  KeyboardEvent: {
    "": "UIEvent;",
...
["dart.math", "dart:math", , P, {
  ...
  Point: {
    ...
    $add: function(_, other) {
      var t1 = new P.Point(C.JSNumber_methods.$add(this.x, C.JSNumber_methods.get$x(other)), J.$add$ns(this.y, C.JSNumber_methods.get$y(other)));
      t1.$builtinTypeInfo = this.$builtinTypeInfo;
      return t1;
    },
    $isPoint: true
...
["", "dartgame.dart", , N, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.get$angleMinus();
    t1.toString;
    t3 = C.EventStreamProvider_click._eventType;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.main_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.get$anglePlus();
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.main_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = $.get$powerSlider();
    t1.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure2()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.get$powerMinus();
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure3()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.get$powerPlus();
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure4()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.get$triggerButton();
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.main_closure5()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = $.get$connectButton();
    t2.toString;
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, t3, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(N.connect$closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = $.get$myNameText();
    t3.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t3, C.EventStreamProvider_keypress._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(N.handleKeyPress$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t3.focus();
  }, "call$0", "main$closure", 0, 0, 1],
  handleKeyPress: [function($event) {
    if (J.get$keyCode$x($event) === 13)
      N.connect(null);
  }, "call$1", "handleKeyPress$closure", 2, 0, 10],
  updateCannon: function(cannon) {
    var t1, t2, t3, angleDegree;
    t1 = J.get$valueAsNumber$x($.get$angleSlider());
    if (typeof t1 !== "number")
      return t1.$div();
    t1 = 1.5707963267948966 - t1 / 180 * 3.141592653589793;
    cannon.angle = t1;
    t2 = $.get$powerSlider();
    t3 = J.get$valueAsNumber$x(t2);
    if (typeof t3 !== "number")
      return t3.$div();
    cannon.power = t3 / 1000;
    ...
    $.get$powerValue().textContent = J.get$value$x(t2);
    N.drawCannon(cannon);
  },
  drawCannon: function(cannon) {
    ...
    if (typeof t7 !== "number")
      return H.iae(t7);
    C.CanvasRenderingContext2D_methods.fillText$3(t1, t4, 0 + t3 * t2.x, t5 - t6 * t7 + 20);
    t7 = tempCanvas.getContext("2d");
    t7.save();
    t7.lineWidth = 5;
    t7.fillStyle = "red";
    t7.strokeStyle = "red";
    ...
    if (typeof t4 !== "number")
      return H.iae(t4);
    t7.translate(0 + t3 * t2.x, t5 - t6 * t4);
    t4 = cannon.angle;
    if (typeof t4 !== "number")
      return t4.$negate();
    t7.rotate(-t4);
    ...
    do {
      ...
      if (x <= 0 || x >= 1 || J.$lt$n(y, 0))
        ...
        if (J.$lt$n(y, J.elementAt$1$ax($.get$landscape(), position))) {
          ...
          if (typeof t2 !== "number")
            return t2.$mul();
          N.drawCircle(canvas, 0 + t4 * x, t1 - t5 * y, "yellow", t2 * 0.03);
      ...
      if (C.JSInt_methods.$mod(i, 25) === 0) {
        ...
        if (typeof t1 !== "number")
          return t1.$sub();
        N.drawCircle(canvas, 0 + t4 * x, t1 - t5 * y, "orange", 1);
      }
      ++i;
    } while (flying);
    N.redrawCanvas();
  ...
  drawLandscape: function(mapProfile) {
    var t1, t2, t3, t4, t5, t6, i, t7, t8;
    t1 = $.get$landscapeCanvas();
    t2 = J.get$context2D$x(t1);
    t2.beginPath();
    t2.lineWidth = 2;
    t2.fillStyle = "lightgrey";
    t2.strokeStyle = "black";
    t3 = J.getInterceptor$ax(mapProfile);
    t4 = t3.elementAt$1(mapProfile, 0);
    t5 = $.get$OFFSET_Y();
    t6 = $.get$SCALE_Y();
    if (typeof t6 !== "number")
      return t6.$mul();
    ...
    if (typeof t5 !== "number")
      return t5.$sub();
    t2.moveTo(0, t5 - t6 * t4);
    t4 = t6;
    t2 = t5;
    i = 1;
    while (true) {
      t5 = t3.get$length(mapProfile);
      if (typeof t5 !== "number")
        return H.iae(t5);
      if (!(i < t5))
        break;
      t5 = C.CanvasElement_methods.get$context2D(t1);
      t6 = t3.get$length(mapProfile);
      if (typeof t6 !== "number")
        return H.iae(t6);
      t7 = $.get$SCALE_X();
      if (typeof t7 !== "number")
        return t7.$mul();
      t8 = t3.elementAt$1(mapProfile, i);
      if (typeof t4 !== "number")
        return t4.$mul();
      if (typeof t8 !== "number")
        return H.iae(t8);
      if (typeof t2 !== "number")
        return t2.$sub();
      t5.lineTo(0 + t7 * (1 / t6 * i), t2 - t4 * t8);
      ++i;
    }
    ...
    if (typeof t2 !== "number")
      return t2.$sub();
    t1.lineTo(0 + t5 * 1, t2 - t4 * t3);
    t1.lineTo(0 + t5 * 1, t2 - t4 * 0);
    t1.lineTo(0 + t5 * 0, t2 - t4 * 0);
    t1.fill();
    t1.closePath();
    t1.stroke();
  },
  redrawCanvas: function() {
    ...
    t1.toString;
    t2 = t1.getContext("2d");
    t2.clearRect(0, 0, t1.width, t1.height);
    t2.drawImage($.get$landscapeCanvas(), 0, 0);
    t2.drawImage($.get$cannonLeftCanvas(), 0, 0);
    t2.drawImage($.get$cannonRightCanvas(), 0, 0);
    t2.drawImage($.get$windsockCanvas(), 0, 0);
    t2.drawImage($.get$leftFlightpathCanvas(), 0, 0);
    t2.drawImage($.get$rightFlightpathCanvas(), 0, 0);
    t2.drawImage($.get$endCanvas(), 0, 0);
  },
  ...
  main_closure5: {
    ...
    call$1: function(e) {
      var t1, payload;
      t1 = $.get$myCannon();
      payload = C.C_JsonCodec.encode$1(new F.ShotRequestMessage(t1.angle, t1.power, P.DateTime$_now(), "Spieler 1", "SHOT_REQUEST").getBaseMap$0());
      $.webSocket.send(payload);
      return;
    }
  },
      ...
      if (message != null && J.get$isNotEmpty$asx(message)) {
        ...
        if (J.$eq(t2.$index(message, "messageType"), "INIT")) {
          ...
          if (J.$eq(t2.$index(message, "playerType"), "LEFT")) {
            ...
            t3 = $.get$myCannon();
            t3.pos = cannonLeftPos;
            t3.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "LEFT");
            t4 = $.get$enemyCannon();
            t4.pos = cannonRightPos;
            t4.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "RIGHT");
            $.leftCannon = t3;
            $.rightCannon = t4;
          } else {
            enemyName = J.$index$asx(t2.$index(message, "playerNames"), "LEFT");
            t3 = $.get$myCannon();
            t3.pos = cannonRightPos;
            t3.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "RIGHT");
            t4 = $.get$enemyCannon();
            t4.pos = cannonLeftPos;
            t4.remainingShots = J.$index$asx(t2.$index(message, "remainingShots"), "LEFT");
            $.leftCannon = t4;
            $.rightCannon = t3;
          }
          document.querySelector("#enemyName").textContent = C.JSString_methods.$add("vs. ", enemyName);
          N.drawLandscape($.get$landscape());
          t5 = $.wind;
          tempCanvas = W.CanvasElement_CanvasElement(200, 200);
          t6 = J.get$context2D$x(tempCanvas);
          t6.translate(100, 100);
          t6.rotate(-t5 * 3.141592653589793 / 2);
          t5 = $.get$windsockImage();
          t7 = J.get$width$x(t5);
          if (typeof t7 !== "number")
            return t7.$negate();
          t6.drawImage(t5, -t7 / 2, 0);
  ...
  Cannon: {
    "": "Object;pos,angle,power,remainingShots,player"
  }
},
1],
...
["", "messages.dart", , F, {
  ...
  ConnectMessage: {
    "": "AbstractMessage;name,sent,sender,messageType",
    getBaseMap$0: function() {
  ...
  ShotRequestMessage: {
    "": "AbstractMessage;angle,power,sent,sender,messageType",
    getBaseMap$0: function() {
      var mapData = F.AbstractMessage.prototype.getBaseMap$0.call(this);
...
Isolate.$lazy($, "myCannon", "myCannon", "get$myCannon", function() {
  return new N.Cannon(H.setRuntimeTypeInfo(new P.Point(0, 0), [null]), 0, 0, 0, null);
});
